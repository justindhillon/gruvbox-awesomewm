...
complete -c dhclient -o sf -d 'Path to the network configuration script invoked by  dhclient when it gets a …'
complete -c dhclient -l version -d 'Print version number and exit'
complete -c dhclient -s B -d 'Always set the bootp broadcast flag in request packets, so that servers will …'
