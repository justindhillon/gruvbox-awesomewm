...
complete -c btrfs-subvolume -l delete-qgroup -d 'also delete the qgroup 0/subvolid if it exists'
complete -c btrfs-subvolume -l no-delete-qgroup -d 'do not delete the 0/subvolid qgroup (default)'
