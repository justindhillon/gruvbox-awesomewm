...
complete -c firewall-offline-cmd -l get-priority -d 'Get the priority of the zone'
complete -c firewall-offline-cmd -l set-priority -d 'Set the zone\\*(Aqs priority for packet classification'
complete -c firewall-offline-cmd -l get-ingress-priority -d 'Get the ingress priority of the zone'
complete -c firewall-offline-cmd -l set-ingress-priority -d 'Set the zone\\*(Aqs ingress priority for packet classification'
complete -c firewall-offline-cmd -l get-egress-priority -d 'Get the egress priority of the zone'
complete -c firewall-offline-cmd -l set-egress-priority -d 'Set the zone\\*(Aqs egress priority for packet classification'
